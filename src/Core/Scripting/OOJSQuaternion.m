...
private
    ...
    *private = quaternion;
    ...
    if (result != NULL) {
        if (!JS_SetPrivate(context, result, private))
            result = NULL;
    }
...
private
    ...
    if (EXPECT(JS_IsArrayObject(context, quaternionObj))) {
        ...
        if (JS_GetArrayLength(context, quaternionObj, &arrayLength) && arrayLength == 4) {
            if (JS_LookupElement(context, quaternionObj, 0, &arrayW) && JS_LookupElement(context, quaternionObj, 1, &arrayX) && JS_LookupElement(context, quaternionObj, 2, &arrayY) && JS_LookupElement(context, quaternionObj, 3, &arrayZ)) {
                // ...se the four numbers as [w, x, y, z]
                if (!JS_ValueToNumber(context, arrayW, &dVal))
                    return NO;
                outQuaternion->w = dVal;
                if (!JS_ValueToNumber(context, arrayX, &dVal))
                    return NO;
                outQuaternion->x = dVal;
                if (!JS_ValueToNumber(context, arrayY, &dVal))
                    return NO;
                outQuaternion->y = dVal;
                if (!JS_ValueToNumber(context, arrayZ, &dVal))
                    return NO;
...
{
    if (EXPECT(JSObjectGetQuaternion(context, quaternionObj, outQuaternion)))
        return YES;
...
static BOOL QuaternionFromArgumentListNoErrorInternal(JSContext* context, uintN argc, jsval* argv, Quaternion* outQuaternion, uintN* outConsumed, BOOL permitNumberList)
{
    ...
    if (EXPECT_NOT(argc < 4))
        return NO;

    // Given a string, JS_ValueToNumber() returns YES but provides a NaN number.
    if (EXPECT_NOT(!JS_ValueToNumber(context, argv[0], &w) || isnan(w)))
        return NO;
    if (EXPECT_NOT(!JS_ValueToNumber(context, argv[1], &x) || isnan(x)))
        return NO;
    if (EXPECT_NOT(!JS_ValueToNumber(context, argv[2], &y) || isnan(y)))
        return NO;
    if (EXPECT_NOT(!JS_ValueToNumber(context, argv[3], &z) || isnan(z)))
        return NO;
...
static JSBool QuaternionGetProperty(JSContext* context, JSObject* this, jsid propID, jsval* value)
{
    ...
    if (EXPECT_NOT(!JSObjectGetQuaternion(context, this, &quaternion)))
        return NO;
...
static JSBool QuaternionToString(JSContext* context, uintN argc, jsval* vp)
{
    ...
    if (EXPECT_NOT(!GetThisQuaternion(context, OOJS_THIS, &thisq, @"toString")))
        return NO;
...
static JSBool QuaternionToSource(JSContext* context, uintN argc, jsval* vp)
{
    ...
    if (EXPECT_NOT(!GetThisQuaternion(context, OOJS_THIS, &thisq, @"toSource")))
        return NO;
...
static JSBool QuaternionMultiply(JSContext* context, uintN argc, jsval* vp)
{
    ...
    if (EXPECT_NOT(!GetThisQuaternion(context, OOJS_THIS, &thisq, @"multiply")))
        return NO;
...
static JSBool QuaternionDot(JSContext* context, uintN argc, jsval* vp)
{
    ...
    if (EXPECT_NOT(!GetThisQuaternion(context, OOJS_THIS, &thisq, @"dot")))
        return NO;
...
static JSBool QuaternionRotate(JSContext* context, uintN argc, jsval* vp)
{
    ...
    if (EXPECT_NOT(!GetThisQuaternion(context, OOJS_THIS, &thisq, @"rotate")))
        return NO;
    if (EXPECT_NOT(!VectorFromArgumentList(context, @"Quaternion", @"rotate", argc, argv, &axis, &consumed)))
        return NO;
    argv += consumed;
    argc -= consumed;
    if (argc > 0) {
...
static JSBool QuaternionRotateX(JSContext* context, uintN argc, jsval* vp)
{
    ...
    if (EXPECT_NOT(!GetThisQuaternion(context, OOJS_THIS, &quat, @"rotateX")))
        return NO;
...
static JSBool QuaternionRotateY(JSContext* context, uintN argc, jsval* vp)
{
    ...
    if (EXPECT_NOT(!GetThisQuaternion(context, OOJS_THIS, &quat, @"rotateY")))
        return NO;
...
static JSBool QuaternionRotateZ(JSContext* context, uintN argc, jsval* vp)
{
    ...
    if (EXPECT_NOT(!GetThisQuaternion(context, OOJS_THIS, &quat, @"rotateZ")))
        return NO;
...
static JSBool QuaternionNormalize(JSContext* context, uintN argc, jsval* vp)
{
    ...
    if (EXPECT_NOT(!GetThisQuaternion(context, OOJS_THIS, &quat, @"normalize")))
        return NO;
...
static JSBool QuaternionConjugate(JSContext* context, uintN argc, jsval* vp)
{
    ...
    if (EXPECT_NOT(!GetThisQuaternion(context, OOJS_THIS, &quat, @"conjugate")))
        return NO;
...
static JSBool QuaternionVectorForward(JSContext* context, uintN argc, jsval* vp)
{
    ...
    if (EXPECT_NOT(!GetThisQuaternion(context, OOJS_THIS, &thisq, @"vectorForward")))
        return NO;
...
static JSBool QuaternionVectorUp(JSContext* context, uintN argc, jsval* vp)
{
    ...
    if (EXPECT_NOT(!GetThisQuaternion(context, OOJS_THIS, &thisq, @"vectorUp")))
        return NO;
...
static JSBool QuaternionVectorRight(JSContext* context, uintN argc, jsval* vp)
{
    ...
    if (EXPECT_NOT(!GetThisQuaternion(context, OOJS_THIS, &thisq, @"vectorRight")))
        return NO;
...
static JSBool QuaternionToArray(JSContext* context, uintN argc, jsval* vp)
{
    ...
    if (EXPECT_NOT(!GetThisQuaternion(context, OOJS_THIS, &thisq, @"toArray")))
        return NO;
