...
ifeq ($(GNUSTEP_HOST_OS),mingw32)
	...
	ADDITIONAL_OBJC_LIBS = -lglu32 -lopengl32 -lmingw32 -lSDLmain -lSDL -lSDL_mixer -lgnustep-base -ljs32
...
# note the vpath stuff above isn't working for me, so adding src/SDL and src/Core explicitly
	...
	ADDITIONAL_OBJC_LIBS = -lGLU -lGL -lSDL -lpthread -lSDL_mixer -lgnustep-base
